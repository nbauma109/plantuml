 ...
 *
 * ditaa is free software: we can redistribute it and or modify
 * it under the terms of the GNU Lesser General Public License as 
 * published by the Free Software Foundation, either version 3 of
 * the License, or at our option any later version.
 *
 * ditaa is distributed in the hope that it will be useful,
 * but without any warranty.  See the
 * GNU Lesser General Public License for more details.
 *
 * We should have received a copy of the GNU Lesser General Public
...
/**
 * Represents a processed diagram that consists of shapes, composite shapes,
 * and textual elements derived from an ascii based grid.
 * 
 * <p>This constructor performs all processing required for converting
 * the ascii grid into geometric shapes and properly arranged text.  
 * The steps include:</p>
 *
 * <ol>
 *   <li>Copying the provided grid into a working grid and removing type on line markers and point markers.</li>
 *   <li>Extracting distinct shapes through an abstraction grid.</li>
 *   <li>Computing all possible boundaries for each discovered shape.</li>
 *   <li>Removing boundary duplicates.</li>
 *   <li>Removing obsolete boundaries that only represent the sum of smaller ones.</li>
 *   <li>Classifying boundaries as open, closed, or mixed.</li>
 *   <li>Splitting or subtracting mixed boundaries until only closed or open boundaries remain.</li>
 *   <li>Creating closed and open diagram shapes from these boundaries, including arrowheads and markers.</li>
 *   <li>Assigning color information and markup tags to shapes.</li>
 *   <li>Extracting, grouping, positioning, and color correcting textual content.</li>
 * </ol>
 *
 * @param grid the source ascii grid from which the diagram is generated
 * @param options the processing and rendering options that control diagram creation
 */
public class Diagram {
    ...
    public Diagram(TextGrid grid, ConversionOptions options) {
            ...
            for (int yi = 0; yi < height * 3; yi++) {
                for (int xi = 0; xi < width * 3; xi++) {
                    if (fillBuffer.isBlank(xi, yi)) {
                        ...
                        CellSet boundaries =
                            copyGrid.findBoundariesExpandingFrom(copyGrid.new Cell(xi, yi));
        ...
        while (sets.hasNext()) {
            ...
            DiagramComponent shape =
                    DiagramComponent.createClosedFromBoundaryCells(workGrid, set, cellWidth, cellHeight, allCornersRound);
            if (shape != null) {
    ...
    /**
     * Returns all diagram shapes including shapes inside composite shapes.
     *
     * @return all diagram shapes
     */
    ...
    /**
     * Removes obsolete shape sets.
     *
     * @return true if any obsolete sets were removed
     */
    ...
    /**
     * Returns the full height of the diagram in pixels.
     *
    ...
    /**
     * Returns the full width of the diagram in pixels.
     *
    ...
    /**
     * Returns the pixel width of a single cell.
     *
     * @return cell width
     */
    ...
    /**
     * Returns the pixel height of a single cell.
     *
     * @return cell height
     */
    ...
    /**
     * Returns the list of composite shapes contained in the diagram.
     *
    ...
    /**
     * Returns the list of individual diagram shapes.
     *
    ...
    /**
     * Returns all text objects contained in the diagram.
     *
     * @return text objects
     */
